...
#define AI_STROKES_INPUTS_IN_ACTIVATIONS   (4)
#define AI_STROKES_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_STROKES_IN_NUM        (1)

AI_DEPRECATED
#define AI_STROKES_IN \
  ai_strokes_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_STROKES_IN_SIZE { \
  AI_STROKES_IN_1_SIZE, \
}
#define AI_STROKES_IN_SIZE_BYTES { \
  AI_STROKES_IN_1_SIZE_BYTES, \
}
#define AI_STROKES_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_STROKES_IN_1_CHANNEL     (320)
#define AI_STROKES_IN_1_SIZE        (320)
#define AI_STROKES_IN_1_SIZE_BYTES  (1280)

/******************************************************************************/
#define AI_STROKES_OUT_NUM       (1)

AI_DEPRECATED
#define AI_STROKES_OUT \
  ai_strokes_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_STROKES_OUT_SIZE { \
  AI_STROKES_OUT_1_SIZE, \
}
#define AI_STROKES_OUT_SIZE_BYTES { \
 ...
 * @ref ai_strokes_create. Both the activations memory buffer 
 ...
 * using @ref ai_strokes_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_strokes_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_strokes_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_STROKES_*
 * defines into file @ref strokes.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
